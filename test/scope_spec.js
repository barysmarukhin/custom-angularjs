...
describe('digest', function() {
    ...
    it("triggers same watchers in the same digest", function() {
       ...
       scope.$watch(
           ...
           function(newValue, oldValue, scope) {
               if(newValue) {
                   scope.initial = newValue.slice(0, 1) + '.';
               }
           }
       );
       scope.$watch(
    ...
    it("executes $appli'ed function and starts the digest", function() {
    ...
    describe('$watchGroup', function() {
        ...
        it("calls the listener once when the watch array is empty", function() {
            ...
            //without digest function above these expectations will be failed because
            //the digest is called inside SetTimeout at these case
    ...
    describe("inheritance", function() {
        ...
        it("can manipulate parent scope's properly", function() {
            var parent = new Scope();
            var child = parent.$new();
        ...
        it('can be nested at any depths', function() {
            var a = new Scope();
            var aa = a.$new();
            var aaa = aa.$new();
            var aab = aa.$new();
